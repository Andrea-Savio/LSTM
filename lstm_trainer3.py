...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        print("Loss: " + str(loss))
        if epoch%5 == 0:
            torch.save(model.state_dict(), "models/model_complete/3layers_10epochs_" + "checkpoint_" + str(epoch) + ".pt") 
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    torch.save(model.state_dict(), "models/model_complete/3layers_10epochs.pt") 
