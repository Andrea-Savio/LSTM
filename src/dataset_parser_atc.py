...
# Define file path and some useful variables for array dimension
    ...
    with open('atc-20121031.csv', 'r') as csvfile:
        # Read the CSV file
        ...
        coordinates = np.zeros((4606, 60000, 4), dtype=np.float32)        #(17558,65662,4). 4390, 4390
        for n in range(len(counter)):                                                   #(18435, 114383, 4), 2303
            counter[n] = 0
    ...
    with open('atc-20121031.csv', 'r') as csvfile:
        ...
        for row in csvreader:
            ...
            if  2302< j < 4606 and counter[j] < 59999:
...
if __name__ == '__main__':
    ...
    torch.save(x, 'atc_20121031_tensor2.pt')
    print("Dataset saved")
    
    """
    
    xx = torch.load('atc_tracking_part1/atc_20121024/atc_20121024_tensor1.pt')
    reshaped_tensor = xx[:,:,0:2].reshape(-1,2)#.view(-1, 1)
    ...
    dump(scaler, open('scaler_2d_atc.pkl', 'wb'))
    print("Scaler saved")
    #print(xx)
